                ...
                <div class="header_right float-right">
                    ...
                    @if(Auth::id())
                        @if(Auth::guard('web')->user()->id)
                                <a href="{{url('user/home')}}" class="btn btn-outline-warning"
                                style="margin-right: 15px; margin-left:15px;">Home</a>
                        @elseif(Auth::guard('owner')->user()->id)
                                <a href="{{url('owner/home')}}" class="">Home</a>
                        @elseif(Auth::guard('admin')->user()->id)
                                <a href="{{url('admin/home')}}" class="">Home</a>
                                @endif
                        ...
                        <div class="col-sm-12">
                            <div class="body-signup__form">
                                <div class="profile__sign-up">
                                    <a href="{{route('user.user_login')}}" data-toggle="modal" class="btn btn-primary btn-block" style="background-color:#2d4052; color: white;">
                                    <i class="fa fa-user"></i> User Login</a>
                                    ...
                                    style="background-color: #2d4052;color: white;">
                                        <i class="fa fa-home"></i> Hostel Owner Login</a>
                                        <h4 class="from-seperator"><span>As</span></h4>
                                        <a href="{{route('admin.admin_login')}}" data-toggle="modal" class="btn btn-accent btn-block" 
                                    style="background-color: #2d4052;color: white;">
                                        <i class="fa fa-users"></i> Admin Login</a>
                                        <hr>
