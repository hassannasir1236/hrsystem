                        ...
                        <div class="col-12 col-md-12 shadow-lg" style="margin-top:65px;     box-shadow: 0 0 30px #b5a6a6;">
                            <div class="card" style="padding-bottom: 40px;">
                               ...
                               <div class="" style="    display: flex;
                                    ...
                                    padding-top: 16px;
                                    padding-bottom: 16px;">
                                  <img class="d-block w-100" src="{{ asset('hostelimg_upload/'.$project1) }}" alt="First slide" style="width: 100%;height: 272px;border: 10px solid #e1bd85;">
                                </div>
                                @endif
                               <p style="display:none;"> {{$count++}}</p>
                                @endforeach
                                       ...
                                       <div class="col-12 col-md-9">
                                           <div class="row" style=" margin-bottom: 25px;   font-family: 'Poppins', sans-serif;font-size: 14px;line-height: 1.42857143;color: #6f6f6f; padding-top: 57px;">
                                               <div class="col-12">
