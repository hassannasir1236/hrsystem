...
@endsection
  ...
  <h3 class="pb-3">User Forgot Form</h3>
  <div class="form-style">
    @if(session()->has('success'))
      ...
      @endif
  <form method="POST" action="{{route('user.forgot.password.link')}}" class="was-validated">
    @csrf
  ...
  <div>
    <a href="{{ route('user.user_login') }}">Login Page</a>  </div>
  </div>
     <div class="pb-2">
