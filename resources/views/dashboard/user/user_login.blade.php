        ...
        <div class="col-lg-6 mb-5 mb-lg-0">
          <div class="card">
            <div class="card-body py-5 px-md-5">
              <form class="was-validated" method="post" action="{{route('user.check')}}">
                @csrf
                <!-- Email input -->
                ...
                <div class="form-check mb-4">
                  ...
                  <a href="{{route('user.forgot.password.form')}}" class="text-primary">Forget Password?</a>
                </div>
