    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-12 col-md-12 ml-auto d-flex justify-content-end pt-4">
            ...
            <button type="button" class="btn btn-primary " id="business_button"  onclick="owner()">
                Update Your Profile
            </button>
        </div>
          ...
          <div class="card pt-4 mb-4 shadow mt-5 rounded-6" style="background-color: #eee">
              ...
              <div class="bg-image hover-overlay ripple rounded-circle text-center" data-mdb-ripple-color="light">
                  <img class="text-center w-50 rounded-circle img-fluid" style="border: 14px solid #c5c1c1;"
                      @if(Auth::guard('owner')->user()->profile)
              ...
              <div class="card-body text-center">
                  <form method="post" action="{{route('owner.OwnerImage')}}" enctype="multipart/form-data" class="d-flex justify-content-center align-items-center flex-column">
                  @csrf
        ...
        <div class="col-12 col-md-8">
          <div class="card pt-4 mb-4 shadow mt-5 rounded-6 " id="business_data"  style="display: block;">
              <div class="card-body">
                  ...
                  <div class="row">
                      ...
                      <div class="col-sm-9">
                          <p class="text-muted mb-0">{{Auth::guard('owner')->user()->manager_name}}</p>
                      </div>
                  </div>
                  <hr>
                  <div class="row">
                      ...
                      <div class="col-sm-9">
                          <p class="text-muted mb-0">{{Auth::guard('owner')->user()->email}}</p>
                      </div>
                  </div>
                  <hr>
                  <div class="row">
                      ...
                      <div class="col-sm-9">
                          <p class="text-muted mb-0">{{Auth::guard('owner')->user()->manager_phoneno}}</p>
                      </div>
                  </div>
                  <hr>
                  <div class="row">
                      <div class="col-sm-3">
                          <b class="mb-0">Your Cnic No:</b>
                      </div>
                      <div class="col-sm-9">
                          <p class="text-muted mb-0">{{Auth::guard('owner')->user()->manager_cnic}}</p>
                      </div>
                  </div>
              </div>
          </div>
          ...
          <div class="card-body d-flex flex-column justify-content-center align-items-center">
            ...
            <form class="py-3 px-4 col-12 col-md-6 col-lg-8" method="post" action="{{route('owner.UpdateProfile')}}">
               @csrf
                <!-- Email input -->
                <div class="mb-4 col">
                    <div class="form-outline ">
                      <label class="form-label" for="form1Example1">Your Name</label>
                        <input type="text" name="name" id="form1Example1" class="form-control" value="{{Auth::guard('owner')->user()->manager_name}}" placeholder="Enter Your Name:" required />
                    </div>
                ...
                <div class="col mb-4">
                    <div class="form-outline">
                      <label class="form-label" for="form1Example2">Your Email</label>
                        <input type="email" id="form1Example2" class="form-control" name="email"  value="{{Auth::guard('owner')->user()->email}}" placeholder="Enter Your Email:" required/>
                    </div>
                ...
                <div class="col mb-4">
                    <div class="form-outline">
                      <label class="form-label" for="form1Example2">Your Phone No:  </label>
                        <input type="number" id="form1Example2" class="form-control" name="phoneno" value="{{Auth::guard('owner')->user()->manager_phoneno}}" placeholder="Enter Your Phone No(only 11 Digits):" required/>
                    </div>
                ...
                <div class="col mb-4">
                    <div class="form-outline">
                        <input type="hidden" id="form1Example2" class="form-control" 
                        name="cnic" value="{{Auth::guard('owner')->user()->manager_cnic}}" placeholder="Enter Your Cnic No(only 13 Digits):" required/>
                    </div>
