            ...
            <div class="container">
                ...
                <div class="header_right float-right">
                    ...
                    <span class="login-register">
                            ...
                            <a href="{{route('user.user_register')}}">@lang('lang.register')</a>
                        </span>
            ...
            <div class="container">
                ...
                <nav class="header_menu">
                    <ul class="menu">
                        ...
                        <li><a href="{{route('owner.post_property')}}">@lang('lang.post_property')</a></li>
                        ...
                        <div class="col-sm-12">
                            <div class="body-signup__form">
                                <div class="profile__sign-up">
                                    ...
                                    <a href="{{route('owner.owner_login')}}" data-toggle="modal" class="btn btn-accent btn-block" 
                                    style="background-color: #2d4052;color: white;">
                                        <i class="fa fa-home"></i> Hostel Owner</a>
                                        <hr>
                                        <p>Not registered? <a href="{{route('user.user_register')}}" 
...
<div class="container">
    <div class="row mt-5 mb-5">
        <div class="col-12 col-md-12">
            <form action="{{route('owner.reset.password')}}" class="was-validated" method="POST">
                @csrf
              <input type="hidden" name="token" value="{{ $token }}">
              <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Email address</label>
                <input type="email" name="email" class="form-control form-control-lg  @error($email ?? old('email')) is-invalid @enderror" required value="{{ $email ?? old('email') }}" id="exampleInputEmail1" aria-describedby="emailHelp">
                <span class="text-danger">@error('email'){{$message}} @enderror</span>
              </div>
              <div class="mb-3">
                <label for="exampleInputPassword1" class="form-label">Password</label>
                <input type="password" name="password" class="form-control form-control-lg  @error('passwprd') is-invalid @enderror" required id="exampleInputPassword1">
              ...
              <button type="submit" class="btn btn-primary" style="width: 9%;
                height: 32px; font-size: 14px; font-weight: 50;font-style: inherit;">Submit</button>
               <a href="{{route('user.user_login')}}" style="float: right; ">Login Page</a>
            </form>
        </div>
    </div>
</div>
